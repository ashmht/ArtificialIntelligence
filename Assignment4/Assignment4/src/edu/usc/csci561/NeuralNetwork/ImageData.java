...
public class ImageData {
	...
	public static ArrayList<ImageData> readImageFile(String imagesPath) {
	...
	/*public static void main(String[] args) {
		String dir = "E:\\Users\\Home\\workspace\\Assignment4\\";

		ArrayList<ImageData> imagesTrain = readData(dir
				+ "train-images.idx3-ubyte", dir + "train-labels.idx1-ubyte");
		ArrayList<ImageData> imagesTest = readData(dir
				+ "test-images.idx3-ubyte", dir + "test-labels.idx1-ubyte");
